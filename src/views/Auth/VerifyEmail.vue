            ...
            <div>
              <div class="mb-5 sm:mb-8">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">
                  Please set your account password to verify your email.
                </p>
              </div>
              <div>
...
const handleSubmit = async () => {
    ...
    try {
        const message = await authStore.verifyEmail(token.value, password.value, confirmPassword.value)
        successMessage.value = message || 'Email verified successfully!'
        
        setTimeout(() => {
            router.push('/signin')
        }, 2000)
    } catch (err: any) {
        errorMessage.value = err.message || 'Failed to verify email'
        loading.value = false
    }
}
</script>
